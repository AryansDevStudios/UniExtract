...
export default function PlaylistView({ playlist, onToast }) {
 ...
 exit={{ opacity: 0, y: -10 }}
 className="w-full bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 rounded-2xl p-4 sm:p-5 md:p-6 shadow-lg space-y-6"
 >
 {/* 1. PLAYLIST HEADER BANNER */}
 <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 border-b border-zinc-200/60 dark:border-zinc-800/80 pb-6">
 <div className="flex items-center gap-4">
 <div className="relative w-20 h-20 md:w-24 md:h-24 rounded-xl overflow-hidden bg-zinc-100 dark:bg-zinc-800 flex-shrink-0 shadow-lg border border-zinc-200/50 dark:border-zinc-700/50">
 {playlist.thumbnail ? (
 ...
 <span className="absolute bottom-1.5 left-2 text-[10px] font-black text-white px-1.5 py-0.5 rounded-md bg-black">
 {totalItems} VIDEOS
 </span>
 </div>
 ...
 <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-md text-[10px] font-black tracking-wider uppercase bg-indigo-500 text-indigo-600 dark:text-indigo-400 border border-indigo-500/20">
 ...
 <h2 className="text-xl md:text-2xl font-black text-zinc-900 dark:text-white tracking-tight leading-snug line-clamp-2">
 {playlist.title}
 </h2>
 </div>
 </div>
 ...
 <div className="w-full lg:w-auto flex flex-col sm:flex-row gap-4 bg-zinc-50 dark:bg-zinc-800 p-3.5 rounded-xl border border-zinc-200/60 dark:border-zinc-700/60 shadow-sm">
 ...
 className="w-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 text-zinc-800 dark:text-zinc-100 rounded-lg px-3 py-2 text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-indigo-500/40 cursor-pointer disabled:opacity-50"
 >
 ...
 <div className="flex items-center justify-between text-[9px] text-zinc-400 gap-1 pt-0.5">
 ...
 className="w-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 text-zinc-800 dark:text-zinc-100 rounded-lg px-3 py-2 text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-purple-500/40 cursor-pointer disabled:opacity-50"
 >
 ...
 <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5 px-4 py-2.5 bg-indigo-50 dark:bg-indigo-950 border border-indigo-200/80 dark:border-indigo-800/80 rounded-xl text-xs">
 ...
 <span className="text-[10px] font-mono font-bold px-2.5 py-0.5 rounded-md bg-indigo-100 dark:bg-indigo-900 text-indigo-700 dark:text-indigo-200 border border-indigo-200 dark:border-indigo-700">
 Max Video: {maxPlaylistResolution.toUpperCase()}
 </span>
 <span className="text-[10px] font-mono font-bold px-2.5 py-0.5 rounded-md bg-purple-100 dark:bg-purple-900 text-purple-700 dark:text-purple-200 border border-purple-200 dark:border-purple-700">
 Max Audio: {maxPlaylistAudio.toUpperCase()}
 </span>
 </div>
 </div>
 ) : (
 <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5 px-4 py-2 bg-emerald-50 dark:bg-emerald-950 border border-emerald-200/80 dark:border-emerald-800/60 rounded-xl text-xs">
 ...
 <div className="flex items-center gap-2 self-end sm:self-auto flex-wrap">
 <span className="text-[10px] font-mono font-bold px-2.5 py-0.5 rounded-md bg-emerald-100 dark:bg-emerald-900 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-700">
 ...
 className="absolute right-2.5 top-1/2 -tranzinc-y-1/2 text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-200"
 >
 <X size={12} />
 </button>
 )}
 ...
 <span className="px-2 py-0.5 rounded-lg bg-white text-xs font-mono font-bold tracking-tight">
 ~{collectiveTotals.totalFormatted}
 </span>
 )}
 </button>
 ...
 <div className="flex items-center gap-1 bg-indigo-500 text-indigo-600 dark:text-indigo-400 px-2 py-1 rounded-lg text-[11px] font-mono font-bold">
 <Loader2 size={12} className="animate-spin" />
 <span>{statusObj.progress || '0%'}</span>
 </div>
 ) : statusObj?.status === 'completed' ? (
 <div className="flex items-center gap-1 text-emerald-500 bg-emerald-500 px-2 py-1 rounded-lg text-[11px] font-bold whitespace-nowrap">
