...
export default function CompactResultPanel({ 
  ...
  return (
    ...
    >
      {/* LEFT: THUMBNAIL */}
      <div className="relative w-full md:w-48 lg:w-56 aspect-video md:aspect-square flex-shrink-0 group rounded-2xl overflow-hidden bg-black/5 shadow-inner">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center backdrop-blur-[2px]">
          <button 
            ...
            className="translate-y-4 group-hover:translate-y-0 bg-white/20 hover:bg-indigo-500 text-white backdrop-blur-md border border-white/30 font-semibold px-5 py-2.5 rounded-full flex items-center gap-2 transition-all duration-300 shadow-xl"
          >
