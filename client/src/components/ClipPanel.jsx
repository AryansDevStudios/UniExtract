...
export default function ClipPanel({ clipStart, setClipStart, clipEnd, setClipEnd, metadata }) {
 ...
 <span>00:00:00</span>
 <span className="font-semibold text-zinc-500 dark:text-zinc-400">Total: {formatClock(totalDuration)}</span>
 ...
 {isInverted && (
 <div className="mb-3 rounded-lg bg-amber-500 border border-amber-500/30 p-2.5 text-amber-600 dark:text-amber-400 text-xs flex items-center justify-between gap-2 animate-fadeIn">
 <div className="flex items-center gap-2">
