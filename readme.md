...
- **x64 (Intel / AMD)**: `UniExtract-2.8.5-x64-Setup.exe` & `UniExtract-Portable-2.8.5-x64.exe`
- **ARM64 (Snapdragon / Copilot+)**: `UniExtract-2.8.5-arm64-Setup.exe` & `UniExtract-Portable-2.8.5-arm64.exe`
- **Linux**: `UniExtract-2.8.5-x86_64.AppImage` & `UniExtract-2.8.5-amd64.deb`
- **macOS**: `UniExtract-2.8.5-x64.dmg` & `UniExtract-2.8.5-arm64.dmg`
...
- **Response**: `{ "status": "ok", "version": "2.8.5", "uptime": 120, "timestamp": 1725619200000 }`
